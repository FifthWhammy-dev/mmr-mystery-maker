...
def CreateSetupCategoryList():
    ...
    AddShuffle(setupList, CategoryNames.STARTINGITEM, ShuffleNames.ITEM_NTM_BINGO)
    AddShuffle(setupList, CategoryNames.STARTINGITEM, ShuffleNames.ITEM_NTM_R1)
    AddShuffle(setupList, CategoryNames.STARTINGITEM, ShuffleNames.ITEM_NTM_R2)
    AddShuffle(setupList, CategoryNames.STARTINGITEM, ShuffleNames.ITEM_NTM_R3)
    AddShuffle(setupList, CategoryNames.STARTINGITEM, ShuffleNames.ITEM_NTM_R4)
    AddShuffle(setupList, CategoryNames.STARTINGITEM, ShuffleNames.ITEM_NTM_C1)
    AddShuffle(setupList, CategoryNames.STARTINGITEM, ShuffleNames.ITEM_NTM_C2)
    AddShuffle(setupList, CategoryNames.STARTINGITEM, ShuffleNames.ITEM_NTM_C3)
    AddShuffle(setupList, CategoryNames.STARTINGITEM, ShuffleNames.ITEM_NTM_C4)
    AddShuffle(setupList, CategoryNames.STARTINGITEM, ShuffleNames.ITEM_NTM_C5)
